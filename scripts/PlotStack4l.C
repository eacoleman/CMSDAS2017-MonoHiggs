...
public: 
  PlotStack4l(std::string tHistoLabel, 
...
PlotStack4l::PlotStack4l(std::string tHistoLabel, 
                         std::string tInputFile, 
                         int tnRebin, 
                         int tnBins=-1,
                         double txMin=-1,
                         ...
                         bool tUseLogY=true,
                         bool tUseLogX=false,
                         bool tUseDYJets=true,
                         bool tUseDYJetsFromData=false
) {
    
  // SETTINGS AND MAGIC
  histolabel=tHistoLabel;
  inputfile=tInputFile;
  nRebin=tnRebin;

  char tnRebinStr[3];
  sprintf(tnRebinStr,"%i",tnRebin);
  nRebinStr=tnRebinStr;
  ...
  useDYJets=tUseDYJets;
  useDYJetsFromData=tUseDYJetsFromData;
...
//   ll->AddText(0.65, 0.6, text);
  ...
  TLegend* legend = new TLegend( 0.45, 0.75, 0.9, 0.92);
...
//   Color_t h400Color = kRed;
  ...
  if (histlabel.find("hM4l_7")<10 && whichchannel.find("4l")<20){
    ...
    //hframe2= new TH2F("hframe2","hframe2",6000, 70., 182., 1000, 0.5, 2.);// 
    hframe= new TH2F("hframe","hframe",80,70.,2000.,800,0.00004,150000000.);// 4l analysis mass nrebin=5  log X and Y
    hframe2= new TH2F("hframe2","hframe2",6000, 70., 1000., 1000, 0.5, 2.);//
  }

  if (histlabel.find("hM4l_8")<10 && (whichchannel.find("4l")<20)){
    hframe= new TH2F("hframe","hframe",80,70.,252.,500,0.00000004,.0035);// 4l analysis mass nrebin=3
    hframe2= new TH2F("hframe2","hframe2",6000, 70., 252., 1000, 0.1, 4.);// 
  }
  ...
  if (histlabel.find("hMZ_3")<10 && whichchannel.find("4#mu")<20){
    hframe= new TH2F("hframe","hframe",80,60.,200.,500,0.01,700.);// mZ1 mumu
    hframe2= new TH2F("hframe2","hframe2",6000, 60., 200., 1000, 0.5, 2.);// mZ1 mumu
  }
  ...
  if (histlabel.find("hMZ_3")<10 && whichchannel.find("2e2#mu")<20){
    hframe= new TH2F("hframe","hframe",80,60.,150.,500,0.4,1100000.);// mZ1 ee                                             
    hframe2= new TH2F("hframe2","hframe2",6000, 60., 150., 1000, 0.5, 2.);// mZ1 ee
  }

  if (histlabel.find("hMZ_3")<10 && whichchannel.find("4l")<20){
    hframe= new TH2F("hframe","hframe",80,60.,140.,500,0.4,1200.);// mZ1 ee                                             
    hframe2= new TH2F("hframe2","hframe2",6000, 60., 140., 1000, 0.5, 2.);// mZ1 ee
  }
  ...
  if (histlabel.find("hPFMET_3")<10){
    hframe= new TH2F("hframe","hframe",1000, 0., 1000., 1000, 0.000001, 10000.);// PFMET
    hframe2= new TH2F("hframe2","hframe2",1000, 0., 1000., 1000, 0.5, 2.);// PFMET
  }
  

  if (histlabel.find("hMZ1_5")<10){
    hframe= new TH2F("hframe","hframe",80,15.,120.,500,0.0001,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",6000, 15., 120., 1000, 0.5, 2.);// mZ1 
  }

  if (histlabel.find("hMZ2_5")<10){
    hframe= new TH2F("hframe","hframe",80,15.,120.,500,0.0000000001,100000000.);// mZ2 
    hframe2= new TH2F("hframe2","hframe2",6000, 15., 120., 1000, 0.5, 2.);// mZ2 
  }
  
  if (histlabel.find("hMZ1_8")<10){
    hframe= new TH2F("hframe","hframe",80,15.,120.,500,0.0001,10000000.);// mZ1 
    hframe2= new TH2F("hframe2","hframe2",6000, 15., 120., 1000, 0.5, 2.);// mZ1 
  }
  
  if (histlabel.find("hMZ2_8")<10){
    hframe= new TH2F("hframe","hframe",80,15.,120.,500,0.0001,10000000.);// mZ2 
    hframe2= new TH2F("hframe2","hframe2",6000, 15., 120., 1000, 0.5, 2.);// mZ2 
  }
  
  if (histlabel.find("hM4l_T_8")<10 ){
    hframe= new TH2F("hframe","hframe",80,15.,1200.,500,0.00000004,100000.);// transverse mass , M4l+MET
    hframe2= new TH2F("hframe2","hframe2",6000, 15., 1200., 1000, 0.5, 2.);// 
  }

  if (histlabel.find("DPHI_8")<10 ){
    hframe= new TH2F("hframe","hframe",80,0,3.14,500,0.00000004,1000000000.);// deltaphi 4l,MET
  ...
  if (histlabel.find("hPFMET_8")<10){
    ...
    hframe= new TH2F("hframe","hframe",1000, 0., 1000., 1000, 0.000001, 1000.);// PFMET
    hframe2= new TH2F("hframe2","hframe2",1000, 0.,1000., 1000, 0.5, 2.);// PFMET
  }
  ...
  if (nRebin==2 && (histlabel.find("hPFMET_8")<10 ||histlabel.find("hPFMET_3")<10 )) hframe->SetYTitle("Events/2 GeV"); // PFMET
  ...
  TH1F *hfourlepbestmass_4l_afterSel_new_ZH     = new TH1F("hfourlepbestmass_4l_afterSel_new_ZH", "hfourlepbestmass_4l_afterSel_new_ZH",Nbins, Xmin, Xmax);
  TH1F *hfourlepbestmass_4l_afterSel_new_WH     = new TH1F("hfourlepbestmass_4l_afterSel_new_WH", "hfourlepbestmass_4l_afterSel_new_WH",Nbins, Xmin, Xmax);
  ...
  for ( int datasetId=Vdatasetnamebkg.size()-1; datasetId >=0; datasetId--){  
	...
	hfourlepbestmass_4l_afterSel_new_VH->SetLineColor(kOrange-1); 
        ...
        char temp[328];
        sprintf(temp,"%s",histosdir.c_str());
        if(datasetnamebkg.find("WminusH") < 200 && datasetnamebkg.find(temp) < 200 && (datasetnamebkg.find(whichenergy) < 200 || datasetnamebkg.find(whichsample) < 200) && hfourlepbestmass_4l_afterSel_new_WH->GetEntries()>0. ) legend->AddEntry(hfourlepbestmass_4l_afterSel_new_WH,"WH", "F");//, m_{H}=125 GeV/c^{2}", "F");  
        //hfourlepbestmass_4l_afterSel_new_new->Draw("sameP");    
      }
	...
	char temp[328];
	sprintf(temp,"%s",histosdir.c_str());
	if(datasetnamebkg.find("ZH_H") < 200 && datasetnamebkg.find(temp) < 200 && (datasetnamebkg.find(whichenergy) < 200 || datasetnamebkg.find(whichsample) < 200) && hfourlepbestmass_4l_afterSel_new_VH->GetEntries()>0. ) legend->AddEntry(hfourlepbestmass_4l_afterSel_new_new,Vlabelbkg.at(datasetId).c_str(), "F");  
	//hfourlepbestmass_4l_afterSel_new_new->Draw("sameP");    
      }
	...
	"  Entries= " << hfourlepbestmass_4l_afterSel_new_new->Integral(0,-1);
      ...
      if(datasetnamebkg.find("GluGluToZZTo4mu_BackgroundOnly") < 200 && (datasetnamebkg.find(whichenergy) < 200 || datasetnamebkg.find(whichsample) < 200) ){ 
	...
	cout << "Label= qqZZ+ggZZ (mll>100 and mll<800)  bins=" << bin100 << "-" << bin800 << " Entries= " << hfourlepbestmass_4l_afterSel_new_ZZ->Integral(bin100,bin800) <<endl;
      ...
      cout << "useDYJetsFromData= " << useDYJetsFromData << endl;
	...
	//legend->AddEntry(hfourlepbestmass_4l_afterSel_new_new,Vlabelbkg.at(datasetId).c_str(), "F"); 
      ...
      else if(datasetnamebkg.find("output_ST_") < 200 ){
	...
	hfourlepbestmass_4l_afterSel_new_singlet->SetLineColor(kViolet);
  ...
  TH1F *hfourlepbestmass_4l_afterSel_new_signal126 = new TH1F("hfourlepbestmass_4l_afterSel_new_signal126", "hfourlepbestmass_4l_afterSel_new_signal126", Nbins, Xmin, Xmax);
  TH1F *hfourlepbestmass_4l_afterSel_new_signal200 = new TH1F("hfourlepbestmass_4l_afterSel_new_signal200", "hfourlepbestmass_4l_afterSel_new_signal200", Nbins, Xmin, Xmax);
  TH1F *hfourlepbestmass_4l_afterSel_new_signal350 = new TH1F("hfourlepbestmass_4l_afterSel_new_signal350", "hfourlepbestmass_4l_afterSel_new_signal350", Nbins, Xmin, Xmax);
  TH1F *hfourlepbestmass_4l_afterSel_new_signal500 = new TH1F("hfourlepbestmass_4l_afterSel_new_signal500", "hfourlepbestmass_4l_afterSel_new_signal500", Nbins, Xmin, Xmax);
  TH1F *hfourlepbestmass_4l_afterSel_new_signal800 = new TH1F("hfourlepbestmass_4l_afterSel_new_signal800", "hfourlepbestmass_4l_afterSel_new_signal800", Nbins, Xmin, Xmax);
  TH1F *hfourlepbestmass_4l_afterSel_new_signalgg125 = new TH1F("hfourlepbestmass_4l_afterSel_new_signalgg125", "hfourlepbestmass_4l_afterSel_new_signalgg125", Nbins, Xmin, Xmax);
  TH1F *hfourlepbestmass_4l_afterSel_new_signalvbf125 = new TH1F("hfourlepbestmass_4l_afterSel_new_signalvbf125", "hfourlepbestmass_4l_afterSel_new_signalvbf125", Nbins, Xmin, Xmax);
  ...
  TH1F *hfourlepbestmass_4l_afterSel_new_monoH_MZP1200 = new TH1F("hfourlepbestmass_4l_afterSel_new_monoH_MZP1200", "hfourlepbestmass_4l_afterSel_new_monoH_MZP1200", Nbins, Xmin, Xmax);
  ...
  for ( int datasetIdSig=Vdatasetnamesig.size()-1; datasetIdSig >=0; datasetIdSig--){  
    ...
    TH1 *hfourlepbestmass_4l_afterSel_new_new=hfourlepbestmass_4l_afterSel_new->Rebin(nRebin, histlabel.c_str()/*"hfourlepbestmass_4l_afterSel_new_new"*/);
    //if (datasetnamesig.find("GluGluToHToZZTo4L_M-350")  !=-1) hfourlepbestmass_4l_afterSel_new_new->SetLineColor(kOrange-3);
    //if (datasetnamesig.find("GluGluToHToZZTo4L_M-200")  !=-1) hfourlepbestmass_4l_afterSel_new_new->SetLineColor(kOrange+7);
    //if (datasetnamesig.find("GluGluToHToZZTo4L_M-125")  !=-1) hfourlepbestmass_4l_afterSel_new_new->SetLineColor(kRed-4);
    //if (datasetnamesig.find("GluGluToHToZZTo4L_M-126")  !=-1) hfourlepbestmass_4l_afterSel_new_new->SetLineColor(kBlue-4);
    ...
    //2HDM
    if(datasetnamesig.find("MZP600")<200) hfourlepbestmass_4l_afterSel_new_monoH_MZP600->Add(hfourlepbestmass_4l_afterSel_new_new);
    if(datasetnamesig.find("MZP800")<200) hfourlepbestmass_4l_afterSel_new_monoH_MZP800->Add(hfourlepbestmass_4l_afterSel_new_new);
    if(datasetnamesig.find("MZP1000")<200) hfourlepbestmass_4l_afterSel_new_monoH_MZP1000->Add(hfourlepbestmass_4l_afterSel_new_new);
	...
	bincont800[nbins-1]=bincont800[nbins-1]+float(hfourlepbestmass_4l_afterSel_new_new->GetBinContent(nbins));
      }
  ...
  if (errorH126>0.) errorH126=sqrt(errorH126);
  if (errorH200>0.) errorH200=sqrt(errorH200);
  if (errorH350>0.) errorH350=sqrt(errorH350);
  if (errorH500>0.) errorH500=sqrt(errorH500);
  ...
  */
  ...
  hfourlepbestmass_4l_afterSel_new_signal126->SetLineColor(kRed-4);
  ...
  hfourlepbestmass_4l_afterSel_new_signal126->SetMarkerSize(0.95);
  hfourlepbestmass_4l_afterSel_new_signal200->SetMarkerSize(0.95);
  hfourlepbestmass_4l_afterSel_new_signal350->SetMarkerSize(0.95);

  hfourlepbestmass_4l_afterSel_new_signal350->SetMarkerColor(kOrange-3);
  hfourlepbestmass_4l_afterSel_new_signal200->SetMarkerColor(kOrange+7);
  hfourlepbestmass_4l_afterSel_new_signal125->SetMarkerColor(kRed-4);
  hfourlepbestmass_4l_afterSel_new_signal126->SetMarkerColor(kBlue-4);
  ...
  if (histlabel.find("hM4l_7")<10 || 
    ...
    legend->AddEntry(hfourlepbestmass_4l_afterSel_new_monoH_MZP600,"m_{Z'}=600 GeV/c^{2}","L");
    legend->AddEntry(hfourlepbestmass_4l_afterSel_new_monoH_MZP800,"m_{Z'}=800 GeV/c^{2}","L");
    legend->AddEntry(hfourlepbestmass_4l_afterSel_new_monoH_MZP1000,"m_{Z'}=1 TeV/c^{2}", "L");
    legend->AddEntry(hfourlepbestmass_4l_afterSel_new_monoH_MZP1200,"m_{Z'}=1.2 TeV/c^{2}","L");
    legend->AddEntry(hfourlepbestmass_4l_afterSel_new_monoH_MZP1400,"m_{Z'}=1.4 TeV/c^{2}","L");
    legend->AddEntry(hfourlepbestmass_4l_afterSel_new_monoH_MZP1700,"m_{Z'}=1.7 TeV/c^{2}","L");
...
//   c1->SaveAs(saveasepszoom.c_str()/*"plots/hfourlepbestmass_4l_afterSel_new_m4l.eps"*/);
  ...
  if (nRebin==10 && histlabel.find("hM4l_8")<10){
    ...
    std::string saveaspdf = useLogY ? "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_log"+nRebinStr+".pdf" : "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_"+nRebinStr+".pdf";
    std::string saveaspng = useLogY ? "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_log"+nRebinStr+".png" : "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_"+nRebinStr+".png";
    std::string saveaseps = useLogY ? "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_log"+nRebinStr+".eps" : "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_"+nRebinStr+".eps";
...
//     c1->SaveAs(saveaseps.c_str()/*"plots/hfourlepbestmass_4l_afterSel_new_m4l.eps"*/);
  ...
  std::string saveaspdfratio = useLogY ? "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_ratio_log_"+nRebinStr+".pdf" : "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_"+nRebinStr+"_ratio.pdf";
  std::string saveaspngratio = useLogY ? "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_ratio_log_"+nRebinStr+".png" : "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_"+nRebinStr+"_ratio.png";
  std::string saveasepsratio = useLogY ? "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_ratio_log_"+nRebinStr+".eps" : "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_"+nRebinStr+"_ratio.eps";
  std::string saveasrootratio= useLogY ? "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_ratio_log_"+nRebinStr+".root": "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_ratio.root";
  std::string saveasCratio= useLogY ? "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_"+nRebinStr+"_ratio_log.C": "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_"+nRebinStr+"_ratio.C";
  ...
  c1->SaveAs(saveasCratio.c_str()/*"plots/hfourlepbestmass_4l_afterSel_new_m4l.C"*/);
...
void PlotStack4l::setSamplesNames4l()
{
  ...
  while(std::getline(infile,inputfilename)){
    ...
    // 2HDM
    else if(inputfilename.find("MZP")<200 ){
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("ZH, m_{H}=125");// GeV/c^{2}");
	Vxsectionbkg.push_back(1.); //pb
	...
	//cout << "VH" << endl;
	  ...
	  Vdatasetnamebkg.push_back(inputfilename);
	  Vlabelbkg.push_back("ZH,ll,2l2#nu");//, m_{H}=125 GeV/c^{2}");
	  Vxsectionbkg.push_back(1.); //pb                                                                                                                                                          
	  Vcolorbkg.push_back(kOrange-1);
	  //cout << "ZH" << endl;               
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
        Vlabelbkg.push_back("WplusH");//, m_{H}=125 GeV/c^{2}");
        Vxsectionbkg.push_back(1.); //pb
        Vcolorbkg.push_back(kOrange+2);
        //cout << "VH" << endl;
      }
      if( (inputfilename.find("M125")<200 && (inputfilename.find("WminusH")<200)) ){
        Vdatasetnamebkg.push_back(inputfilename);
        Vlabelbkg.push_back("WminusH");//, m_{H}=125 GeV/c^{2}");
        Vxsectionbkg.push_back(1.); //pb
        Vcolorbkg.push_back(kOrange+3);
        //cout << "VH" << endl;
      }
	...
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("WH");//, m_{H}=125 GeV/c^{2}");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kOrange-1);
	//cout << "VH" << endl;
      }
	...
	Vcolorbkg.push_back(kPink+5);
      ...
      // ggZZ 4e
      if(inputfilename.find("GluGluToZZTo4e")<200){
        Vdatasetnamebkg.push_back(inputfilename);
        Vlabelbkg.push_back("Z#gamma^{*],ZZ");
        Vxsectionbkg.push_back(1.); //pb
        Vcolorbkg.push_back(kPink+5);
       ...
       // ggZZ 4mu
      if(inputfilename.find("GluGluToZZTo4mu")<200){
        Vdatasetnamebkg.push_back(inputfilename);
        Vlabelbkg.push_back("Z#gamma^{*],ZZ");
        Vxsectionbkg.push_back(1.); //pb
        Vcolorbkg.push_back(kPink+5);
      ...
      // ggZZ 4tau
      if(inputfilename.find("GluGluToZZTo4tau")<200){
        Vdatasetnamebkg.push_back(inputfilename);
        Vlabelbkg.push_back("Z#gamma^{*],ZZ");
        Vxsectionbkg.push_back(1.); //pb
        Vcolorbkg.push_back(kPink+5);
       ...
       // ggZZ 2e2mu
      if(inputfilename.find("GluGluToZZTo2e2mu")<200){
        Vdatasetnamebkg.push_back(inputfilename);
        Vlabelbkg.push_back("Z#gamma^{*],ZZ");
        Vxsectionbkg.push_back(1.); //pb
        Vcolorbkg.push_back(kPink+5);
       ...
       // ggZZ 2e2tau
      if(inputfilename.find("GluGluToZZTo2e2tau")<200){
        Vdatasetnamebkg.push_back(inputfilename);
        Vlabelbkg.push_back("Z#gamma^{*],ZZ");
        Vxsectionbkg.push_back(1.); //pb
        Vcolorbkg.push_back(kPink+5);
      ...
      // ggZZ 2mu2tau
      if(inputfilename.find("GluGluToZZTo2mu2tau")<200){
        Vdatasetnamebkg.push_back(inputfilename);
        Vlabelbkg.push_back("Z#gamma^{*],ZZ");
        Vxsectionbkg.push_back(1.); //pb
        Vcolorbkg.push_back(kPink+5);
